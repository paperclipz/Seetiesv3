...
-(void)setDealType{
    ...
    if ([self.dealModel.deal_type isEqualToString:DEAL_TYPE_FREE]) {
        ...
        self.ibDiscountLbl.hidden = NO;
        self.ibDealTypeLbl.text = [NSString stringWithFormat:@"%@ %@", self.dealModel.currency_code, self.dealModel.discounted_item_price];
        NSDictionary *attributes = @{NSStrikethroughStyleAttributeName:[NSNumber numberWithInt:NSUnderlineStyleSingle]};
        NSAttributedString *attrText = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@" %@ %@ ", self.dealModel.currency_code, self.dealModel.original_item_price] attributes:attributes];
