...
- (id)initWithViewControllers:(NSArray *)vcs imageArray:(NSArray *)arr
{
	...
	if (self != nil)
	{
		...
		_transitionView.backgroundColor =  [UIColor blueColor];
		
		_tabBar = [[LeveyTabBar alloc] initWithFrame:CGRectMake(0, screenHeight - kTabBarHeight, screenWidth, kTabBarHeight) buttonImages:arr];
