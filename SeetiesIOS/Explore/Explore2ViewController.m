...
//    [MainScroll addSubview:ShowOverlayImg];
   ...
   // [CollectionViewNowButton addTarget:self action:@selector(LetsgoButton:) forControlEvents:UIControlEventTouchUpInside];
    ...
    for (int i = 0 ; i < [self.exploreCountryModels.countries count]; i++) {
        ...
        switch (i) {
            case 0:
                ShowCountryImg.backgroundColor = [UIColor colorWithRed:122.0f/255.0f green:109.0f/255.0f blue:191.0f/255.0f alpha:1.0f];
                break;
            case 1:
                ShowCountryImg.backgroundColor = [UIColor colorWithRed:149.0f/255.0f green:174.0f/255.0f blue:242.0f/255.0f alpha:1.0f];
                break;
            case 2:
                ShowCountryImg.backgroundColor = [UIColor colorWithRed:241.0f/255.0f green:115.0f/255.0f blue:112.0f/255.0f alpha:1.0f];
                break;
            case 3:
                ShowCountryImg.backgroundColor = [UIColor colorWithRed:255.0f/255.0f green:224.0f/255.0f blue:116.0f/255.0f alpha:1.0f];
                break;
            case 4:
                ShowCountryImg.backgroundColor = [UIColor colorWithRed:204.0f/255.0f green:244.0f/255.0f blue:106.0f/255.0f alpha:1.0f];
                break;
            case 5:
                ShowCountryImg.backgroundColor = [UIColor colorWithRed:239.0f/255.0f green:251.0f/255.0f blue:158.0f/255.0f alpha:1.0f];
                break;
            case 6:
