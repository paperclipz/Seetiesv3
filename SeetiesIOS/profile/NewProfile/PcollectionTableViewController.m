//
//  PcollectionTableViewController.m
//  SeetiesIOS
//
...
@interface PcollectionTableViewController ()

@end

@implementation PcollectionTableViewController
...
-(void)initTableViewWithDelegate:(id)delegate
{
     ...
     [self.tableView registerClass:[ProfileCollectionTableViewCell class] forCellReuseIdentifier:@"ProfileCollectionTableViewCell"];
