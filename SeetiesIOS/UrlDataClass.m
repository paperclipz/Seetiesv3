    ...
    if (self = [super init]) {
        ...
        if ([CheckAPI isEqualToString:@"0"]) {
          //  NSLog(@"CheckAPI is 0");
            ...
            Publish_PostUrl = @"https://itcave-api.seeties.me/v1.3/post";
            CategoryIDN_Url = @"https://itcave-api.seeties.me/v1.3/system/update/category";
            Feed_Url = @"https://itcave-api.seeties.me/v1.3/feed";
            Explore_Url = @"https://itcave-api.seeties.me/v1.3/explore";
            UserWallpaper_Url = @"https://itcave-api.seeties.me/v1.3/";
            Suggestions_Url = @"https://itcave-api.seeties.me/v1.3/user/suggestions";
            GetComment_URl = @"https://itcave-api.seeties.me/v1.3/post";
            UserLogout_Url = @"https://itcave-api.seeties.me/v1.3/logout";
            GetAlllangauge_Url = @"https://itcave-api.seeties.me/v1.3/system/languages";
            GetNotification_Url = @"https://itcave-api.seeties.me/v1.3/notifications";
            GetDrafts_Url = @"https://itcave-api.seeties.me/v1.3/draft";
            GetNotificationCount_Url = @"https://itcave-api.seeties.me/v1.3/notifications/count";
            GetAllCategory_Url = @"https://itcave-api.seeties.me/v1.3/system/update/category";
            GetFestivals_Url = @"https://itcave.seeties.me/festivals?hidden=header";
            GetNearbyPost_Url = @"https://itcave-api.seeties.me/v1.3/post/";//:post_id/nearbyposts?token="
