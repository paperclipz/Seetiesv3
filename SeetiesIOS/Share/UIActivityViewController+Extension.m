...
+ (UIActivityViewController *)ShowShareViewControllerOnTopOf:(UIViewController*)viewController WithDataToPost:(CustomItemSource *)dataToPost {
    ...
    CustomUIActivity *customFBControl = [[CustomUIActivity alloc] initWithTitle:@"Facebook" activityImage:[UIImage imageNamed:@"SSFacebookIcon"] activityType:@"com.seeties.PostToFacebook" completionBlock:^(id object){
