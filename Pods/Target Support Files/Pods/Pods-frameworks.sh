...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods/ADTransitionController.framework"
  ...
  install_framework "Pods/LPGoogleFunctions.framework"
  install_framework "Pods/MGInstagram.framework"
  ...
  install_framework "Pods/PDKTStickySectionHeadersCollectionViewLayout.framework"
